...
function ColourModal () {
    ...
    const colourData = [
        {c1: '#230078', c2: '#FDF3E5', c3: '#8CB41E'},
        {c1: '#9381FF', c2: '#FFEEDD', c3: '#B8B8FF'},
        {c1: '#D4A373', c2: '#FAEDCD', c3: '#606C38'},
    ]
                            ...
                            {colourData.map((item) => {
                                return (
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setOpen(false)
                                            setColour(item.c1, item.c2, item.c3)
                                            navigate('/home')
                                        }}
                                    >
                                        <div className="flex flex-col justify-center text-white rounded-md w-32 h-24" style={{backgroundColor: item.c1}}>{item.c1}</div>
                                        <div className="flex flex-col justify-center text-black rounded-md w-32 h-24" style={{backgroundColor: item.c2}}>{item.c2}</div>
                                        <div className="flex flex-col justify-center text-white rounded-md w-32 h-24" style={{backgroundColor: item.c3}}>{item.c3}</div>
                                    </button>
                                    <br />
                                    </>
                                )
